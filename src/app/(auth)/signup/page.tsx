          ...
          <AnimatePresence mode="wait">
            {verifyingEmail ? (
              ...
              >
                ...
                <h2 className="font-serif text-xl text-bureau-text mb-2">Verify your email</h2>
              ...
              >
                <h2 className="font-serif text-xl text-bureau-text mb-1">Join the Bureau</h2>
                ...
                <p className="font-sans text-center text-xs text-bureau-dim mt-6">
                  ...
                  <Link href="/login" className="text-bureau-gold hover:text-amber-400 transition-colors">
                    Sign in
                  </Link>
                </p>
              </motion.div>
